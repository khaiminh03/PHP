	...
	<div class="container">
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				...
				echo "<td>"
		?>
				<a class="btn btn-primary" href="sua_lop.php?ma=<?php echo $row["maLop"]; ?>">Sửa</a>
				<?php
				echo "</td>";
				echo "<td>"
				?>
				<a onclick="return confirm('Có thực sự muốn xóa không?')" href="xoa_lop.php?ma=<?php echo $row["maLop"]; ?> ">Xóa</a>
		<?php
				echo "</td>";
				echo "</tr>";
			}
